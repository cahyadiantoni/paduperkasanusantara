      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?= base_url('admin/product/tambah') ?>" class="nav-link">
                <i class="fas fa-plus nav-icon"></i>
                <p>Tambah Product</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url('admin/kategori_product') ?>" class="nav-link">
                <i class="fas fa-tags nav-icon"></i>
                <p>Kategori Product</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url('admin/brand_product') ?>" class="nav-link">
                <i class="fas fa-tags nav-icon"></i>
                <p>Brand Product</p>
              </a>
            </li>
